...
class OnCallState(State):
    ...
    investigation_score: float = Field(default=0.01)
    root_cause_score: float = Field(default=0.01)
    remediation_score: float = Field(default=0.01)
    efficiency_score: float = Field(default=0.01)
    sla_score: float = Field(default=0.01)
    penalty_total: float = Field(default=0.01)
